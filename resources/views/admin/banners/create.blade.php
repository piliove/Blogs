					...
					<div class="form-body"> 
						<form action="/admin/banners/store" method="post" enctype="multipart/form-data"> 
							...
							<div class="form-group"> 
								...
								<input type="text" class="form-control" name="title" value="{{ old('title') }}" id="title" placeholder="请输入轮播图标题..." /> 
							</div> 
							<div class="form-group"> 
								<label for="desc">轮播图描述</label> 
								<input type="text" class="form-control" name="desc" value="{{ old('desc') }}" id="desc" placeholder="请输入轮播图描述..." /> 
							</div>
              <div class="form-group"> 

					...
					<div class="form-body"> 
						<form action="/admin/articles/store" method="post"  enctype="multipart/form-data"> 
							...
							<div class="form-group"> 
								...
								<input type="text" class="form-control" name="title" value="" id="title" placeholder="请输入文章标题..." /> 
							</div>
                            <div class="form-group"> 
								<label for="auth">作者</label> 
								<input type="text" class="form-control" name="auth" value="" id="auth" placeholder="请输入文章作者..." /> 
							</div>
                            <div class="form-group"> 
								<label for="desc">描述</label> 
								<input type="text" class="form-control" name="desc" value="" id="desc" placeholder="请输入文章描述..." /> 
							</div>
                            <div class="form-group"> 
                            ...
                            <!-- 加载编辑器的容器 -->
                            <script id="content" name="content" type="text/plain" style="min-height:300px;"></script>
                            </div>
                            <!-- 百度富文本编辑器 -->
                            <!-- 配置文件 -->
